nc 10.15.43.32 3403
 ...
 A. search ftp mencari trafic yang ada username & password
  - USER ind@psg420.com
  - PASS {6r_6e#TfT1p

B. What credential did the attacker use to log in?
Format: user:pass
- ind@psg420.com:{6r_6e#TfT1p

C. How many files are suspected of containing malware?
Format: int
- 5
